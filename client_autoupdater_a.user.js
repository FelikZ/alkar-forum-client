	...
	function Script()
	{
        var soptions = {
            ...
            ***************************************************/
            ...
            Vualizator settings
            ***************************************************/
            "enable_vual_all_button": false,		//Показывать кнопку "завуалировать все"
            "enable_vual_part_button": false,	//Показывать кнопку "завуалировать часть"
            "auto_vualization": true,			//Включить авто-вуализацию
            /***************************************************
            Fast settings
            ***************************************************/
