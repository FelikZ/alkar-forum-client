# alkar-forum-client
Automatically exported from code.google.com/p/alkar-forum-client

Use to be a userscript for games.alkar.net forums.

Outdated but here for history.
...
```json
{
  "enable_smiles": true,
  "enable_style": true,
  "enable_vualizator": true,
  "enable_linkyfy": true,
  "enable_flash_videos": true,
  "enable_quote_hider": true,
  "enable_quote_force_hide": false,
  "enable_ignore_remover": true,
  "enable_uncounter": false,
  "enable_status": true,
  "enable_auto_topic_sort": true,
  "enable_topic_hover_links": true,
  "enable_extended_ignore": false,
  "enable_punisher": false,
  "theme": 0,
  "enable_qip_smiles": true,
  "enable_goha_smiles": true,
  "enable_anime_smiles": true,
  "enable_yap_smiles": true,
  "enable_spoiler": true,
  "tags_before": "[b]",
  "color": "#220000",
  "tags_after": "[/b]",
  "enable_auto_vualization": true,
  "enable_fast_reply": true,
  "enable_fast_paging": true,
  "enable_fast_refresh": true,
  "enable_auto_page_refresh": true,
  "auto_page_refresh_interval": "60",
